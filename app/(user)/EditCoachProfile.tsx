        ...
        <>
          <KeyboardAwareScrollView style={{ flex: 1 }}
            ...
            <View style={styles.formContainer}>
              <Text style={{ color: 'black', fontSize: 20, fontWeight: 'bold', marginTop: 5 }}>Personal Info</Text>
    ...
    return (
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <>
          <KeyboardAwareScrollView style={{ flex: 1 }}>
            <View style={styles.formContainer}>
              <Text style={{ color: 'black', fontSize: 20, fontWeight: 'bold', marginTop: 5 }}>Address</Text>
              <View style={styles.mgTop}>
    ...
    return (
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <>
          <KeyboardAwareScrollView style={{ flex: 1 }}>
            <View style={styles.formContainer}>
              <Text style={{ color: 'black', fontSize: 20, fontWeight: 'bold', marginTop: 5 }}>Sport Info</Text>
              <View style={styles.mgTop}>

                <Text style={styles.textLabel}>Your Sport</Text>
                <RNPickerSelect
                  style={{ inputIOS: styles.inputStyle, inputAndroid: styles.inputStyle }}
                  items={evalbleSports.map(sport => ({ label: sport.name, value: sport.id, key: sport.id }))}
                ...
                <RNPickerSelect
                  style={{ inputIOS: styles.inputStyle, inputAndroid: styles.inputStyle }}
                  items= {Array.from({length: 40}, (_, i) => i).map(i => ({ label: i.toString(), value: i, key: i }))}
    ...
    <>
       <ImageBackground
        ...
        <SafeAreaView style={{ flex: 1 }}>
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <CustomNavigationHeader text={"Coach"} showBackArrow={true} showSkip={false} showLogo={false} goBackFunction={goBackFunc()} />
          </TouchableWithoutFeedback>
